...
# Copilot Coding Agent Instructions for NetAmplify
...
- SDK (`apps/sdk`) provides programmatic access to NetAmplify features.
...
## Documentation
- Main docs: https://docs.netamplify.com/
- Developer guide: https://docs.netamplify.com/developer-guide
- Public API: https://docs.netamplify.com/public-api
