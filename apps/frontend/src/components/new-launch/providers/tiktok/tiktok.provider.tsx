...
import { TiktokPreview } from '@netamplify/frontend/components/new-launch/providers/tiktok/tiktok.preview';
import { TikTokMusicSelector } from '@netamplify/frontend/components/new-launch/providers/tiktok/tiktok.music';
import { TikTokLocationSelector } from '@netamplify/frontend/components/new-launch/providers/tiktok/tiktok.location';
...
const TikTokSettings: FC<{
  ...
  const tiktokRestrictionNotice = useMemo(() => {
    ...
    return t(
      ...
      'TikTok restriction: For upload-only video, TikTok does not accept a title or message. The content will default to "#NetAmplify" and you can edit it inside the TikTok app before publishing.'
    );
