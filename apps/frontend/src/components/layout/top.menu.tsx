...
import { MenuItem } from '@netamplify/frontend/components/new-layout/menu-item';
import { useModals } from '@netamplify/frontend/components/layout/new-modal';
import { AgentMediaModal } from '@netamplify/frontend/components/layout/agent.media.modal';
...
export const useMenuItem = () => {
  ...
  const secondMenu = [
    ...
    },
    {
      ...
      path: 'https://affiliate.netamplify.com',
      role: ['ADMIN', 'SUPERADMIN', 'USER'],
      requireBilling: true,
    },
    {
