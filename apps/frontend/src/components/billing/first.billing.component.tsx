...
import { LogoTextComponent } from '@netamplify/frontend/components/ui/logo-text.component';
...
import { CheckIconComponent } from '@netamplify/frontend/components/ui/check.icon.component';
import {
  FAQComponent,
  FAQSection,
} from '@netamplify/frontend/components/billing/faq.component';
...
import SafeImage from '@netamplify/react/helpers/safe.image';
...
import { DeveloperIconComponent } from '@netamplify/frontend/components/developer/developer.icon.component';
...
const EmbeddedBilling = dynamic(
  () =>
    import('@netamplify/frontend/components/billing/embedded.billing').then(
...
export const FirstBillingComponent = () => {
  ...
  const showYouTube = () => {
    modals.openModal({
      title: 'Grow Fast With NetAmplify (Play the video)',
      children: (
        <iframe
          className="h-full aspect-video min-w-[800px]"
          src="https://www.youtube.com/embed/BdsCVvEYgHU?si=vvhaZJ8I5oXXvVJS?autoplay=1"
          title="NetAmplify Tutorial"
          allow="autoplay"
          allowFullScreen
        />
      ),
    ...
    return (
      <>
        <div className="text-[46px] font-[600] leading-[110%] tablet:text-[36px] mobile:!text-[30px] whitespace-pre-line text-balance">
          ...
          {t(
            'billing_netamplify_grow_social',
            'NetAmplify To Grow Their Social Presence'
          )}
        </div>
        ...
        <div className="flex" onClick={showYouTube}>
          <div className="tablet:mb-[32px] cursor-pointer mt-[32px] flex gap-[10px] items-center underline hover:font-[700]">
            ...
            <div>See the power of NetAmplify (click here)</div>
          </div>
        </div>
