...
import {
  ...
  getMaxSize,
} from '@netamplify/nestjs-libraries/upload/custom.upload.validation';
...
import { UploadFactory } from '@netamplify/nestjs-libraries/upload/upload.factory';
import { MediaService } from '@netamplify/nestjs-libraries/database/prisma/media/media.service';
import { GetPostsDto } from '@netamplify/nestjs-libraries/dtos/posts/get.posts.dto';
import { ChangePostStatusDto } from '@netamplify/nestjs-libraries/dtos/posts/change.post.status.dto';
import { UpdatePostSettingsDto } from '@netamplify/nestjs-libraries/dtos/posts/update.post.settings.dto';
import {
  AuthorizationActions,
  Sections,
} from '@netamplify/backend/services/auth/permissions/permission.exception.class';
import { VideoDto } from '@netamplify/nestjs-libraries/dtos/videos/video.dto';
import { VideoFunctionDto } from '@netamplify/nestjs-libraries/dtos/videos/video.function.dto';
import { UploadDto } from '@netamplify/nestjs-libraries/dtos/media/upload.dto';
import { NotificationService } from '@netamplify/nestjs-libraries/database/prisma/notifications/notification.service';
import { GetNotificationsDto } from '@netamplify/nestjs-libraries/dtos/notifications/get.notifications.dto';
import { Readable } from 'stream';
import { ssrfSafeDispatcher } from '@netamplify/nestjs-libraries/dtos/webhooks/ssrf.safe.dispatcher';
...
import {
  ...
  IntegrationManager,
} from '@netamplify/nestjs-libraries/integrations/integration.manager';
import { getValidationSchemas } from '@netamplify/nestjs-libraries/chat/validation.schemas.helper';
import { RefreshIntegrationService } from '@netamplify/nestjs-libraries/integrations/refresh.integration.service';
import { RefreshToken } from '@netamplify/nestjs-libraries/integrations/social.abstract';
import { PostValidationException } from '@netamplify/backend/api/routes/posts.validation.exception';
