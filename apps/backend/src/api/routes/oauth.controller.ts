...
import { AuthorizeOAuthQueryDto, ApproveOAuthDto } from '@netamplify/nestjs-libraries/dtos/oauth/authorize-oauth.dto';
import { TokenExchangeDto } from '@netamplify/nestjs-libraries/dtos/oauth/token-exchange.dto';
