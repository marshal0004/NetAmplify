...
import { LoginUserDto } from '@netamplify/nestjs-libraries/dtos/auth/login.user.dto';
import { AuthService } from '@netamplify/backend/services/auth/auth.service';
import { ForgotReturnPasswordDto } from '@netamplify/nestjs-libraries/dtos/auth/forgot-return.password.dto';
import { ForgotPasswordDto } from '@netamplify/nestjs-libraries/dtos/auth/forgot.password.dto';
import { ResendActivationDto } from '@netamplify/nestjs-libraries/dtos/auth/resend-activation.dto';
...
export class AuthController {
  ...
  mobileCallback(
    ...
    const scheme = process.env.MOBILE_APP_SCHEME || 'netamplify://auth/callback';
