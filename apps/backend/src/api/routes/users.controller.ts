...
import { AuthService as AuthChecker } from '@netamplify/helpers/auth/auth.service';
...
import { EmailNotificationsDto } from '@netamplify/nestjs-libraries/dtos/users/email-notifications.dto';
import { HttpForbiddenException } from '@netamplify/nestjs-libraries/services/exception.filter';
