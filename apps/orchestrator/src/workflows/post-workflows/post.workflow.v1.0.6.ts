...
import { PostResponse } from '@netamplify/nestjs-libraries/integrations/social/social.integrations.interface';
...
import { postId as postIdSearchParam } from '@netamplify/nestjs-libraries/temporal/temporal.search.attribute';
