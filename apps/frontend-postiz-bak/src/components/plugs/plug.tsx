...
import {
  ...
  PlugsInterface,
  usePlugs,
} from '@netamplify/frontend/components/plugs/plugs.context';
...
import { ModalWrapperComponent } from '@netamplify/frontend/components/new-launch/modal.wrapper.component';
