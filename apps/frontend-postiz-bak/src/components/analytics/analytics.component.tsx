...
import { StarsAndForks } from '@netamplify/frontend/components/analytics/stars.and.forks';
import { FC, useCallback } from 'react';
import { StarsTableComponent } from '@netamplify/frontend/components/analytics/stars.table.component';
