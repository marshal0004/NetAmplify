...
import { InstagramCollaboratorsTags } from '@netamplify/frontend/components/new-launch/providers/instagram/instagram.tags';
import { InstagramAudioSelector } from '@netamplify/frontend/components/new-launch/providers/instagram/instagram.audio';
...
import { InstagramPreview } from '@netamplify/frontend/components/new-launch/providers/instagram/instagram.preview';
const postType = [
  {
    value: 'post',
    label: 'Post / Reel',
