...
import { InternalChannels } from '@netamplify/frontend/components/launches/internal.channels';
...
export { PostComment } from '@netamplify/frontend/components/new-launch/providers/post-comment.enum';
import { PostComment } from '@netamplify/frontend/components/new-launch/providers/post-comment.enum';
