...
import { MediumTags } from '@netamplify/frontend/components/new-launch/providers/medium/medium.tags';
...
import { YoutubePreview } from '@netamplify/frontend/components/new-launch/providers/youtube/youtube.preview';
const type = [
  {
    label: 'Public',
    value: 'public',
