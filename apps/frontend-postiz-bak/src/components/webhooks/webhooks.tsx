...
import { Select } from '@netamplify/react/form/select';
import { PickPlatforms } from '@netamplify/frontend/components/launches/helpers/pick.platform.component';
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="text-customColor18 mt-[4px]">
        {t(
          'webhooks_are_a_way_to_get_notified_when_something_happens_in_netamplify_via_an_http_request',
          'Webhooks are a way to get notified when something happens in NetAmplify via\n        an HTTP request.'
        )}
      </div>
        ...
        body: JSON.stringify([
          {
            ...
            integration: {
              ...
              picture: 'https://uploads.netamplify.com/F6LSCD8wrrQ.jpeg',
              type: 'social',
            },
          },
          {
