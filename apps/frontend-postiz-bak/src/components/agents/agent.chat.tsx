...
import { Input } from '@netamplify/frontend/components/agents/agent.input';
...
import {
  MediaPortal,
  PropertiesContext,
} from '@netamplify/frontend/components/agents/agent';
        ...
        <div className="absolute left-0 w-full h-full pb-[20px]">
          <CopilotChat
            ...
            labels={{
              ...
              initial: t('agent_welcome_message', `Hello, I am your NetAmplify agent 🙌🏻.
