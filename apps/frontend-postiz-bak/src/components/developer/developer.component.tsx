...
import { useDecisionModal, useModals } from '@netamplify/frontend/components/layout/new-modal';
import { MediaBox } from '@netamplify/frontend/components/media/media.component';
      ...
      <div className="flex flex-col gap-[40px]">
        <div className="text-[14px] text-textColor leading-[1.7]">
          {t(
            ...
            'Create an OAuth App to let other NetAmplify users authorize your product to post on their behalf.'
          )}
          <br />
          {t(
          ...
          <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder flex items-start justify-between gap-[12px]">
            <div>
              ...
              <div className="text-[13px] text-customColor18 mt-[2px]">
                {t(
                  ...
                  'Create an OAuth application to allow third-party integrations with NetAmplify on behalf of your users.'
                )}
              </div>
            </div>
            <div className="flex gap-[6px] shrink-0 pt-[2px]">
              <a
                ...
                href="https://docs.netamplify.com/public-api/oauth"
                target="_blank"
              >
