...
import { sanitizePostContent } from '@netamplify/helpers/utils/sanitize.post.content';
...
import { CommentsComponents } from '@netamplify/frontend/components/preview/comments.components';
import dayjs from 'dayjs';
import utc from 'dayjs/plugin/utc';
import { VideoOrImage } from '@netamplify/react/helpers/video.or.image';
import { CopyClient } from '@netamplify/frontend/components/preview/copy.client';
import { getT } from '@netamplify/react/translation/get.translation.service.backend';
import { RenderPreviewDateClient } from '@netamplify/frontend/components/preview/render.preview.date.client';
import { CreationMethodBadge } from '@netamplify/frontend/components/launches/creation.method.badge';

dayjs.extend(utc);
export const metadata: Metadata = {
  title: `${isGeneralServerSide() ? 'NetAmplify' : 'Gitroom'} Preview`,
  description: '',
};
