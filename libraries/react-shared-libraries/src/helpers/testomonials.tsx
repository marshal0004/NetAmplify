export const testimonials1 = [
  ...
  },
  {
    ...
    content: (
      <>
        I just found out about NetAmplify, a tool for scheduling social media.{' '}
        {'\n'}
        ...
        {'\n'}
        NetAmplify seems to focus on just doing one thing well. {'\n'}
        {'\n'}
      </>
    ),
  },
  {
    ...
    content: (
      <>
        As a privacy-first company we appreciate being able to self-host NetAmplify!
  ...
  },
  {
    ...
    content: (
      <>
        NetAmplify changed how we manage our social media presence by aggregating
        our platforms into one effective tool. Post scheduling, and AI post
        ideation are two of the many features that come with NetAmplify, and have
  ...
  },
  {
    ...
    content: (
      <>
        ...
        n8n + NetAmplify =🔥Never miss a day of posting again: {'\n\n'}→ Easy to get
  ...
  },
  {
    ...
    content: (
      <>
        Manage all your social media accounts from a single place: NetAmplify, a
...
export const testimonials2 = [
  {
    ...
    content: (
      <>
        🌟 Exciting news! 🚀 I've just started using NetAmplify, a fantastic new
        tool for scheduling my social media content! {'\n\n'}
        Why did I choose NetAmplify? The ability to self-host it means significant
        savings for me! 💰 {'\n\n'}
        NetAmplify is an open-source scheduling tool that allows you to plan and
        ...
        scheduling! 📅✨ {'\n\n'}
        Built with privacy and flexibility in mind, NetAmplify can run on your own
  ...
  },
  {
    ...
    content: (
      <>
        NetAmplify makes it so easy to plan ahead. The AI suggestions are relevant,
