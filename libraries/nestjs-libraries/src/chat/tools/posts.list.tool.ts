...
Posts cannot be deleted through the NetAmplify tools - if the user wants to delete a post, tell them to do it themselves in the NetAmplify app; never offer to delete a post.
`,
