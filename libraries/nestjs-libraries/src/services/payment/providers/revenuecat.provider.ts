...
import { REVENUECAT_PROVIDER } from '@netamplify/nestjs-libraries/services/payment/payment.providers';
...
// app_user_id === NetAmplify organization id (the app calls Purchases.logIn(orgId)).
// Product ids end with <tier>.<period> or <tier>_<period>, e.g. com.netamplify.mob.pro.yearly
