...
import { MediaDto } from '@netamplify/nestjs-libraries/dtos/media/media.dto';
import {
  allProviders,
  type AllProvidersSettings,
  EmptySettings,
} from '@netamplify/nestjs-libraries/dtos/posts/providers-settings/all.providers.settings';
import { ValidContent } from '@netamplify/helpers/utils/valid.images';
