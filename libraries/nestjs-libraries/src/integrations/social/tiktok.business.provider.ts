...
import { Tool } from '@netamplify/nestjs-libraries/integrations/tool.decorator';
...
@Rules(
  [
    ...
    'Media is pulled by TikTok from its URL, so the media must be uploaded to NetAmplify and the media domain must be a verified URL property of the TikTok Business app.',
  ].join(' ')
)
  ...
  implements SocialProvider
{
  ...
  // auto_add_music flag, so the attached music is chosen by NetAmplify rather than
